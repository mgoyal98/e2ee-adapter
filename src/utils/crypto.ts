...
export async function encrypt(
  data: string,
  publicKey: string
): Promise<{ encryptedData: string, aesKey: Buffer, iv: Buffer, originalAesKey: Buffer }> {
  try {
 ...
 */
export function decryptAES(encryptedData: string, aesKey: Buffer, iv: Buffer): string {
